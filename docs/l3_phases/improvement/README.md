...
> **進捗の正本は [status-2026-08-28.md](status-2026-08-28.md)（再監査）**。
> 本ファイルと phase\*.md は 2026-07-03 時点の分析であり、チェックボックスは実装に追随していない
> （C1 / C2 / C7 / C15 / C17 / C18 / C21 / C22 / C23 / C29 は対応済み）。現況と優先順位は再監査側を参照する。
